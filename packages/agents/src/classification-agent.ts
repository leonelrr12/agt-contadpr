...
export const KEYWORD_MAP: Record<string, string[]> = {
  ...
  supermercados: ['Alimentación', 'Alimentacion', 'Alimentación'],
  super: ['Alimentación', 'Alimentacion', 'Alimentación'],
  // Alimentos comunes en facturas de supermercado
  uvas: ['Alimentación', 'Alimentacion'],
  uva: ['Alimentación', 'Alimentacion'],
  manzana: ['Alimentación', 'Alimentacion'],
  naranja: ['Alimentación', 'Alimentacion'],
  leche: ['Alimentación', 'Alimentacion'],
  jugo: ['Alimentación', 'Alimentacion'],
  pan: ['Alimentación', 'Alimentacion'],
  arroz: ['Alimentación', 'Alimentacion'],
  aceite: ['Alimentación', 'Alimentacion'],
  huevos: ['Alimentación', 'Alimentacion'],
  huevo: ['Alimentación', 'Alimentacion'],
  pollo: ['Alimentación', 'Alimentacion'],
  pescuezo: ['Alimentación', 'Alimentacion'],
  waterwipes: ['Suministros de Limpieza', 'Suministros de Oficina'],
  wipes: ['Suministros de Limpieza', 'Suministros de Oficina'],
  carne: ['Alimentación', 'Alimentacion'],
  carnes: ['Alimentación', 'Alimentacion'],
  res: ['Alimentación', 'Alimentacion'],
  higado: ['Alimentación', 'Alimentacion'],
  hígado: ['Alimentación', 'Alimentacion'],
  pescado: ['Alimentación', 'Alimentacion'],
  queso: ['Alimentación', 'Alimentacion'],
  jamon: ['Alimentación', 'Alimentacion'],
  jamón: ['Alimentación', 'Alimentacion'],
  yogurt: ['Alimentación', 'Alimentacion'],
  cereal: ['Alimentación', 'Alimentacion'],
  verduras: ['Alimentación', 'Alimentacion'],
  vegetales: ['Alimentación', 'Alimentacion'],
  frutas: ['Alimentación', 'Alimentacion'],
  // Frutas
  piña: ['Alimentación', 'Alimentacion'], pina: ['Alimentación', 'Alimentacion'],
  sandía: ['Alimentación', 'Alimentacion'], sandia: ['Alimentación', 'Alimentacion'],
  melón: ['Alimentación', 'Alimentacion'], melon: ['Alimentación', 'Alimentacion'],
  papaya: ['Alimentación', 'Alimentacion'], fresa: ['Alimentación', 'Alimentacion'],
  limón: ['Alimentación', 'Alimentacion'], limon: ['Alimentación', 'Alimentacion'],
  plátano: ['Alimentación', 'Alimentacion'], platano: ['Alimentación', 'Alimentacion'],
  guineo: ['Alimentación', 'Alimentacion'], mango: ['Alimentación', 'Alimentacion'],
  pera: ['Alimentación', 'Alimentacion'], durazno: ['Alimentación', 'Alimentacion'],
  ciruela: ['Alimentación', 'Alimentacion'], kiwi: ['Alimentación', 'Alimentacion'],
  coco: ['Alimentación', 'Alimentacion'], maracuyá: ['Alimentación', 'Alimentacion'],
  maracuya: ['Alimentación', 'Alimentacion'], piñuela: ['Alimentación', 'Alimentacion'],
  // Carnes y embutidos
  cerdo: ['Alimentación', 'Alimentacion'], chuleta: ['Alimentación', 'Alimentacion'],
  costilla: ['Alimentación', 'Alimentacion'], pechuga: ['Alimentación', 'Alimentacion'],
  muslo: ['Alimentación', 'Alimentacion'], alita: ['Alimentación', 'Alimentacion'],
  salchicha: ['Alimentación', 'Alimentacion'], chorizo: ['Alimentación', 'Alimentacion'],
  tocino: ['Alimentación', 'Alimentacion'], mortadela: ['Alimentación', 'Alimentacion'],
  bologna: ['Alimentación', 'Alimentacion'], salami: ['Alimentación', 'Alimentacion'],
  molida: ['Alimentación', 'Alimentacion'], bistec: ['Alimentación', 'Alimentacion'],
  lomo: ['Alimentación', 'Alimentacion'], filete: ['Alimentación', 'Alimentacion'],
  // Verduras
  cebolla: ['Alimentación', 'Alimentacion'], tomate: ['Alimentación', 'Alimentacion'],
  lechuga: ['Alimentación', 'Alimentacion'], zanahoria: ['Alimentación', 'Alimentacion'],
  papa: ['Alimentación', 'Alimentacion'], yuca: ['Alimentación', 'Alimentacion'],
  ñame: ['Alimentación', 'Alimentacion'], name: ['Alimentación', 'Alimentacion'],
  otoe: ['Alimentación', 'Alimentacion'], ají: ['Alimentación', 'Alimentacion'],
  aji: ['Alimentación', 'Alimentacion'], pimentón: ['Alimentación', 'Alimentacion'],
  pimenton: ['Alimentación', 'Alimentacion'], ajo: ['Alimentación', 'Alimentacion'],
  cilantro: ['Alimentación', 'Alimentacion'], perejil: ['Alimentación', 'Alimentacion'],
  apio: ['Alimentación', 'Alimentacion'], brócoli: ['Alimentación', 'Alimentacion'],
  broccoli: ['Alimentación', 'Alimentacion'], coliflor: ['Alimentación', 'Alimentacion'],
  repollo: ['Alimentación', 'Alimentacion'], pepino: ['Alimentación', 'Alimentacion'],
  calabaza: ['Alimentación', 'Alimentacion'], berenjena: ['Alimentación', 'Alimentacion'],
  espinaca: ['Alimentación', 'Alimentacion'], remolacha: ['Alimentación', 'Alimentacion'],
  chayote: ['Alimentación', 'Alimentacion'], zuquini: ['Alimentación', 'Alimentacion'],
  // Lácteos
  mantequilla: ['Alimentación', 'Alimentacion'], margarina: ['Alimentación', 'Alimentacion'],
  ...
  refrescos: ['Refrigerios', 'Alimentación', 'Alimentacion'],
  gaseosa: ['Refrigerios', 'Alimentación', 'Alimentacion'],
  malteada: ['Refrigerios', 'Alimentación', 'Alimentacion'],
  batido: ['Refrigerios', 'Alimentación', 'Alimentacion'],
  smoothie: ['Refrigerios', 'Alimentación', 'Alimentacion'],
  cerveza: ['Refrigerios', 'Alimentación', 'Alimentacion'],
  vino: ['Refrigerios', 'Alimentación', 'Alimentacion'],
  licor: ['Refrigerios', 'Alimentación', 'Alimentacion'],
  ron: ['Refrigerios', 'Alimentación', 'Alimentacion'],
  // Granos y panadería
  harina: ['Alimentación', 'Alimentacion'], avena: ['Alimentación', 'Alimentacion'],
  granola: ['Alimentación', 'Alimentacion'], pasta: ['Alimentación', 'Alimentacion'],
  fideo: ['Alimentación', 'Alimentacion'], spaguetti: ['Alimentación', 'Alimentacion'],
  lasaña: ['Alimentación', 'Alimentacion'], lasana: ['Alimentación', 'Alimentacion'],
  ravioli: ['Alimentación', 'Alimentacion'], canelone: ['Alimentación', 'Alimentacion'],
  // Snacks y dulces
  chocolate: ['Refrigerios', 'Alimentación', 'Alimentacion'],
  dulce: ['Refrigerios', 'Alimentación', 'Alimentacion'],
  caramelos: ['Refrigerios', 'Alimentación', 'Alimentacion'],
  caramelo: ['Refrigerios', 'Alimentación', 'Alimentacion'],
  chicle: ['Refrigerios', 'Alimentación', 'Alimentacion'],
  ...
  farmacia: ['Medicamentos', 'Gastos Médicos'],
  // Ropa / uniformes
  camisa: ['Uniformes', 'Vestuario'],
  pantalón: ['Uniformes', 'Vestuario'],
  pantalon: ['Uniformes', 'Vestuario'],
  uniforme: ['Uniformes', 'Vestuario'],
  // Seguros
